...
// Connection Properties to connect the database
...
// Creating Connection to the database by using using the connection properties.
...
connection.connect((err) => {
    ...
    console.log("\n WELCOME TO EMPLOYEE TRACKER. THIS IS THE GREAT PLACE TO GET THE INFORMATION FOR YOU!!!! \n");
    mainMenu();
});

// here is the main function which make use of inquirer to ask the question
function mainMenu(){
